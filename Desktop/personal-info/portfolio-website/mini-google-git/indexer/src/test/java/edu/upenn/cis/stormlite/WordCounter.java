...
public class WordCounter implements IRichBolt {
	...
	/**
	 * This is a simple map from word to a running count. If we have multiple
	 * "sharded" copies of the WordCounter we'll need to make sure they get
	 * different words, otherwise we'll have multiple partial counts instead of a
	 * single unified one.
	 * 
	 */
	...
	public void execute(Tuple input) {
		if (!isEOS) {
			if (input.isEndOfStream()) {
				System.out.println("EOS detected!");
				isEOS = true;
			} else {
