...
public class TestMapReduce {
	 ...
	 * 
	 * Argument 0: worker index in the workerList (0, 1, ...) Argument 1: non-empty
	 * parameter specifying that this is the requestor (so we know to send the JSON)
	 * 
	 * @param args
	 * @throws Exception
	 */
	public static void main(String[] args) throws Exception {
		...
		// ***** NOTE: This class is just an example code describing how to instantiate
		// the workers,
		// create a new job and send it to them. This code should help you to get
		// started
		// on the MasterServlet and WorkerMain.
		// There are some hard-coded values here - make sure you understand the code
		// before
		// copy-pasting!
...
//		config.put("workerList", "[127.0.0.1:8001]");
		...
		if (args.length >= 1) {
			...
			System.out.println("Worker created. Worker index " + args[0]);
		} else {
			System.out.println("Worker created. Worker index " + 0);
