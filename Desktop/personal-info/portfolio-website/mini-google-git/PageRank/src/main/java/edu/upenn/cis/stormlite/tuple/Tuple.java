...
public class Tuple implements Serializable  {
	...
	public int getSourceWorkerIdx() {
		return this.sourceWorkerIdx;
	}

	public void setSourceWorkerIdx(int sourceWorkerIdx) {
		this.sourceWorkerIdx = sourceWorkerIdx;
	}
