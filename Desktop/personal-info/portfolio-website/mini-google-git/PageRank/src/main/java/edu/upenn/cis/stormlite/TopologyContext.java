...
//	public TopologyContext(Config config, Topology topo, Queue<ITask> theTaskQueue) {
//		topology = topo;
//		taskQueue = theTaskQueue;
//		inputDir  = config.get("inputDir");
//		System.out.println("[TopologyContext]: inputDir = " + inputDir);
//	}
...
//	}
	...
	public void incSpoutOutput() {
		this.spoutOutputs++;
	}
	
	public int getSpoutOutput() {
		return this.spoutOutputs;
	}
