...
public class WorkerServer {
    ...
    static DistributedCluster cluster = new DistributedCluster(1);
    ...
    public static void createWorker(Map<String, String> config) {
        ...
        if (!config.containsKey("workerIndex"))
            ...
            URL url;
            storeDir = config.get("storageDir");
            if(!new File(storeDir).isDirectory()) storeDir = System.getProperty("user.dir") +"/"+storeDir;
            dbDir = storeDir + "/table";
